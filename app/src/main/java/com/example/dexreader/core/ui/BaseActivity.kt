...
import com.example.dexreader.core.ui.util.ActionModeDelegate
import com.example.dexreader.core.ui.util.BaseActivityEntryPoint
import com.example.dexreader.core.ui.util.WindowInsetsDelegate
import com.example.dexreader.core.util.ext.getThemeColor
import com.example.dexreader.core.util.ext.isWebViewUnavailable
...
abstract class BaseActivity<B : ViewBinding> :
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		if (isAmoledTheme) {
			setTheme(R.style.ThemeOverlay_DexReader_Amoled)
		}
	...
	override fun onSupportActionModeStarted(mode: ActionMode) {
		...
		val actionModeColor = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
			...
			ContextCompat.getColor(this, R.color.dexreader_m3_background)
		}
