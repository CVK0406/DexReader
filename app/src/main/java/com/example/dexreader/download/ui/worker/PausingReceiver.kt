...
import com.example.dexreader.core.util.ext.toUUIDOrNull
...
class PausingReceiver(
	...
	companion object {
		...
		private const val ACTION_PAUSE = "com.example.dexreader.download.PAUSE"
		private const val ACTION_RESUME = "com.example.dexreader.download.RESUME"
		private const val ACTION_SKIP = "com.example.dexreader.download.SKIP"
