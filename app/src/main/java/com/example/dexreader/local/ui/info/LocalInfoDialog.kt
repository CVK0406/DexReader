...
import com.example.dexreader.core.ui.widgets.SegmentedBarView
...
import com.example.dexreader.databinding.DialogLocalInfoBinding
...
class LocalInfoDialog : AlertDialogFragment<DialogLocalInfoBinding>(), View.OnClickListener {
	...
	private fun setSegments(size: Long, available: Long) {
		...
		val segment = SegmentedBarView.Segment(
			...
			color = DexReaderColors.segmentColor(view.context, materialR.attr.colorPrimary),
		)
